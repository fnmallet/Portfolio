    ...
    <Section className='gap-6 bg-transparent scroll-mt-100' id={ID.section.home}>
      ...
      <div className='flex flex-col justify-center items-center gap-6 z-20'>
        ...
        <div className='grid grid-cols-2 gap-4 justify-items-center w-69.5'>
          <Button intent='primary' className='flex px-0 w-full justify-center gap-2 items-center'>Proyectos <IconProyects /></Button>
          <Button intent='secondary' className='px-0 w-full'>Mirá mi CV</Button>
        </div>
      </div>
    </Section>
  </div>;
